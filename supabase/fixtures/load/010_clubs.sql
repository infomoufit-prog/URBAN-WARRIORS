-- KOMBAX LOAD FIXTURE · 10 CLUBES · SOLO LOCAL/QA
-- NO EJECUTAR EN PRODUCCIÓN. Requiere habilitación manual de sesión:
--   set app.kombax_load_fixture_enabled = 'on';
-- Volumen nominal: 10 clubes, 30 disciplinas, 40 grupos,
-- 400 socios, 1120 sesiones, 11200 asistencias,
-- 200 notificaciones y 2400 cuotas.
...
do $fixture$
declare
  v_total integer:=10;v_i integer;v_d integer;v_g integer;v_m integer;v_s integer;v_a integer;v_month integer;
