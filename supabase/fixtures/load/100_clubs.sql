-- KOMBAX LOAD FIXTURE · 100 CLUBES · SOLO LOCAL/QA
-- NO EJECUTAR EN PRODUCCIÓN. Requiere habilitación manual de sesión:
--   set app.kombax_load_fixture_enabled = 'on';
-- Volumen nominal: 100 clubes, 300 disciplinas, 400 grupos,
-- 4000 socios, 11200 sesiones, 112000 asistencias,
-- 2000 notificaciones y 24000 cuotas.
...
do $fixture$
declare
  v_total integer:=100;v_i integer;v_d integer;v_g integer;v_m integer;v_s integer;v_a integer;v_month integer;
