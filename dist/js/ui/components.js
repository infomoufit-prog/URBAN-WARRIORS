...
export function shell(navItems,active,mobileItems=[]){
  ...
  const sections={dashboard:'Principal',members:'Gestión',enrollments:'Gestión',catalog:'Club',groups:'Club',sessions:'Clases',attendance:'Clases',progress:'Seguimiento',tracking:'Seguimiento',finance:'Economía',reminders:'Economía',communications:'Contenido',community:'Contenido',material:'Contenido',documents:'Administración',notifications:'Cuenta',users:'Administración',settings:'Administración',diagnostics:'Sistema',certification:'Sistema',requests:'Mi cuenta',install:'Mi cuenta',help:'Ayuda',profile:'Cuenta'};
