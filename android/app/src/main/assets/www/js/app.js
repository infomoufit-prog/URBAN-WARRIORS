...
async function boot(){
  ...
  if('serviceWorker' in navigator&&location.protocol.startsWith('http')&&location.hostname!=='appassets.androidplatform.net')navigator.serviceWorker.register('./service-worker.js?v=20016').catch(e=>console.warn('Service worker:',e));
}
boot();
