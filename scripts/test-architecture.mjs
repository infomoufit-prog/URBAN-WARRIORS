...
assert(/versionCode\s+20010/.test(gradle)&&/versionName '2\.0\.0-rc\.10'/.test(gradle),'Android versionado 2.0.0-rc.10 / 20010');
...
assert(mainActivity.includes('UrbanWarriorsApp/2.0.0-rc.10'),'User-Agent Android acompaña versión RC10');
