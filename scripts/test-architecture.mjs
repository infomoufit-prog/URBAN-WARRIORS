...
assert(/versionCode\s+20016/.test(gradle)&&/versionName '2\.0\.0-rc\.12'/.test(gradle),'Android RC12 versionado con build 20016');
...
assert(mainActivity.includes('UrbanWarriorsApp/2.0.0-rc.12'),'User-Agent Android acompaña versión RC12');
