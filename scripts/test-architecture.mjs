...
console.log('ARQUITECTURA RC9: PASS');
...
assert(/versionCode\s+20009/.test(gradle)&&/versionName '2\.0\.0-rc\.9'/.test(gradle),'Android versionado 2.0.0-rc.9 / 20009');
...
assert(mainActivity.includes('UrbanWarriorsApp/2.0.0-rc.9'),'User-Agent Android acompaña versión RC9');
