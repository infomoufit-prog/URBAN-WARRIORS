...
assert(members.includes("['direccion','coordinacion'].includes(state.session?.rol)")&&(members.includes('Código alumnos/familias')||members.includes('Invitar alumno / familia'))&&members.includes("rotate('alumnos'"),'Gestor/Coordinación gestionan código de alumnos/familias');
