...
const migration=resolve(root,'supabase/migrations/023_scalability_finance_materials_v167.sql');
...
if(!block)throw new Error('No se pudo leer el contrato SQL RC12+');
...
console.log(`OK contrato RC12+ completo: ${used.size}/${allowed.size} operaciones app_mutate_v160 implementadas`);
