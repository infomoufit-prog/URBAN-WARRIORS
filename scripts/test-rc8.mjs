...
assert(cfg.includes("version: '2.0.0-rc.9'")&&cfg.includes('build: 20009')&&cfg.includes("app_diagnostico_final_v165"),'regresión RC8 preservada en RC9 / v165');
...
assert(admin.includes('E2E_RC9_')&&admin.includes('repos.sessions.reserve')&&admin.includes("backend.select('reservas_sesion'"),'E2E RC8 verifica reserva real');
