...
assert(cfg.includes("version: '2.0.0-rc.12'")&&cfg.includes('build: 20016')&&cfg.includes("app_diagnostico_final_v166"),'regresión RC8 preservada en RC12 build 20016 / v166');
