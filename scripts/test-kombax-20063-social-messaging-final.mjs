...
ok(repos.includes('app_kombax_social_network_mutate_v107')&&repos.includes('app_kombax_social_network_mutate_v104')&&repos.includes('app_kombax_contactos_v133')&&repos.includes('app_kombax_contactos_v107')&&repos.includes('app_kombax_contactos_v106')&&repos.includes('app_kombax_contactos_v104')&&repos.includes('app_kombax_header_summary_v107')&&repos.includes('app_kombax_header_summary_v106')&&repos.includes('kombax.showcase.contact.request')&&repos.includes('La mensajería de Showcase necesita activar la actualización 107'),'repositorio prioriza lector acotado v133, conserva fallback v107→v106→v104 y bloquea Showcase si backend 107 aún no está activo');
