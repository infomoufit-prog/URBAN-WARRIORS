...
ok(repos.includes("app_kombax_header_summary_v107")||repos.includes("headerSummary:()=>backend.readRpc('app_kombax_header_summary_v106'")||repos.includes("headerSummary:()=>backend.readRpc('app_kombax_header_summary_v105'")||repos.includes("headerActivity:()=>backend.globalReadRpc('app_kombax_header_activity_v103',{})"),'frontend consume un RPC agregado para la cabecera');
