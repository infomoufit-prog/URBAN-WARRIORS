...
assert(cfg.includes("version: '2.0.0-rc.10'")&&cfg.includes('build: 20010')&&cfg.includes('schemaEpoch: 160')&&cfg.includes("app_diagnostico_final_v166"),'RC10 conserva capa funcional RC6 y compatibilidad epoch 160');
