...
assert(cfg.includes("version: '2.0.0-rc.12'")&&cfg.includes('build: 20016')&&cfg.includes('schemaEpoch: 160')&&cfg.includes("app_diagnostico_final_v166"),'RC12 build 20016 conserva capa funcional RC6 y compatibilidad epoch 160');
