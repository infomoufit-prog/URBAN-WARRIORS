...
assert(cfg.includes("version: '2.0.0-rc.13'")&&cfg.includes('build: 20020')&&cfg.includes('schemaEpoch: 160')&&cfg.includes("app_diagnostico_final_v166"),'RC13 build 20020 conserva capa funcional RC6 y compatibilidad epoch 160');
