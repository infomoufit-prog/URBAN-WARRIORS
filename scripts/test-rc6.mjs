...
assert(cfg.includes("version: '2.0.0-rc.9'")&&cfg.includes('build: 20009')&&cfg.includes('schemaEpoch: 160')&&cfg.includes("app_diagnostico_final_v165"),'RC9 conserva capa funcional RC6 y compatibilidad epoch 160');
...
assert(admin.includes('Personalizar Urban Warriors')&&admin.includes("uploadBrandImage('logo'")&&admin.includes("uploadBrandImage('cover'"),'personalización con logo y portada subida a Storage');
...
assert(admin.includes('Subir y leer documento privado')&&admin.includes('Ciclo de vida seguro')&&admin.includes('E2E_RC9_'),'runner final verifica Storage y lifecycle');
