...
assert(cfg.includes("version: '2.0.0-rc.12'")&&cfg.includes('build: 20016')&&cfg.includes("app_diagnostico_final_v166"),'RC12 build 20016 conserva Gestor/Coordinación de RC9 y diagnóstico v166');
...
assert(pkg.includes('test-rc9.mjs')&&gradle.includes('versionCode 20016')&&gradle.includes("versionName '2.0.0-rc.12'"),'regresión RC9 incluida en tests; Android RC12 build 20016');
