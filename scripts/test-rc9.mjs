...
assert(cfg.includes("version: '2.0.0-rc.13'")&&cfg.includes('build: 20020')&&cfg.includes("app_diagnostico_final_v166"),'RC13 build 20020 conserva Gestor/Coordinación de RC9 y diagnóstico v166');
...
assert(pkg.includes('test-rc9.mjs')&&gradle.includes('versionCode 20020')&&gradle.includes("versionName '2.0.0-rc.13'"),'regresión RC9 incluida en tests; Android RC13 build 20020');
