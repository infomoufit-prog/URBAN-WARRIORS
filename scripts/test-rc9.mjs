...
assert(cfg.includes("version: '2.0.0-rc.9'")&&cfg.includes('build: 20009')&&cfg.includes("app_diagnostico_final_v165"),'versionado RC9 / diagnóstico v165');
...
assert(pkg.includes('test-rc9.mjs')&&gradle.includes('versionCode 20009')&&gradle.includes("versionName '2.0.0-rc.9'"),'tests y Android versionados RC9');
