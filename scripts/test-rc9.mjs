...
assert(cfg.includes("version: '2.0.0-rc.10'")&&cfg.includes('build: 20010')&&cfg.includes("app_diagnostico_final_v166"),'RC10 conserva Gestor/Coordinación de RC9 y diagnóstico v166');
...
assert(pkg.includes('test-rc9.mjs')&&gradle.includes('versionCode 20010')&&gradle.includes("versionName '2.0.0-rc.10'"),'regresión RC9 incluida en tests; Android versionado RC10');
