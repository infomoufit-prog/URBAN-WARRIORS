...
assert(cfg.includes("version: '2.0.0-rc.12'")&&cfg.includes('build: 20016')&&cfg.includes("app_diagnostico_final_v166"),'versionado RC12 build 20016 sobre base RC10 / diagnóstico v166');
...
assert(pkg.includes('test-rc10.mjs')&&gradle.includes('versionCode 20016')&&gradle.includes("versionName '2.0.0-rc.12'")&&sw.includes('rc12-20016'),'tests base RC10 y entrega Android/service worker versionados RC12 build 20016');
