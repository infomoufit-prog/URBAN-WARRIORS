...
assert(cfg.includes("version: '2.0.0-rc.13'")&&cfg.includes('build: 20020')&&cfg.includes("app_diagnostico_final_v166"),'versionado RC13 build 20020 sobre base RC10 / diagnóstico v166');
...
assert(pkg.includes('test-rc10.mjs')&&gradle.includes('versionCode 20020')&&gradle.includes("versionName '2.0.0-rc.13'")&&sw.includes('rc13-20020'),'tests base RC10 y entrega Android/service worker versionados RC13 build 20020');
